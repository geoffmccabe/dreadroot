...
export const TEST_CHALLENGE: Challenge = {
  ...
  waves: [
    ...
    { name: 'Giant Skeletons', timeSec: 60, text: 'Aim high.', drops: [{ type: 3, count: 10, x: CX, z: CZ, staggerMs: 5000 }] },
    { name: 'Vomit Demon',     timeSec: 60, text: 'Keep moving — it spits.', drops: [{ type: 4, count: 1, x: CX, z: CZ }] },
    { name: 'Dark Lords',      timeSec: 60, text: 'They teleport behind you.', drops: [{ type: 5, count: 2, x: CX, z: CZ, staggerMs: 30000 }] },
    { name: 'Bloody Horde',    timeSec: 60, drops: [{ type: 6, count: 20, x: CX, z: CZ }] },
    { name: 'Spintrolls',      timeSec: 60, text: "Don't get caught in their zoom.", drops: [{ type: 7, count: 5, x: CX, z: CZ, staggerMs: 10000 }] },
