...
export const CHAR_ASSET_VERSION = '12';
...
export const LINEUP_CHARS: LineupChar[] = [
  ...
  { name: 'Fluffer', file: '/siege/characters/pilot_fluffer.glb', scale: 1.016, minY: -0.0121 }, // 1.8m; UNTEXTURED until Character.png supplied
];
