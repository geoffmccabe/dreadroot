...
export const CHAR_ASSET_VERSION = '13';
...
export const LINEUP_CHARS: LineupChar[] = [
  ...
  { name: 'Fluffer', file: '/siege/characters/pilot_fluffer.glb', scale: 1.355, minY: -0.0121 }, // 2.4m; UNTEXTURED until Character.png supplied
];
