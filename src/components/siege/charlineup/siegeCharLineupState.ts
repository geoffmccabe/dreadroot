...
export const CHAR_ASSET_VERSION = '26';
...
export const LINEUP_CHARS: LineupChar[] = [
  ...
  { name: 'Fluffer', file: '/siege/characters/pilot_fluffer.glb', scale: 1.181, minY: -0.0139 }, // 2.3m — calibrated vs Dago(2.2m) by actual rendered height (POSITION bbox lies for skinned meshes)
];
