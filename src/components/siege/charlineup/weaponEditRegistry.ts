...
const BAKE_VERSION = '9';   // v9: also baked Double Barrel Shotgun (item_1) — clear its saved tweaks
const BAKED_URLS = new Set(['/siege/weapons/ak47.glb', '/siege/weapons/item_17.glb', '/siege/weapons/item_18.glb', '/siege/weapons/item_19.glb', '/siege/weapons/item_142.glb', '/siege/weapons/item_4.glb', '/siege/weapons/item_12.glb', '/siege/weapons/item_1.glb']);
try {
