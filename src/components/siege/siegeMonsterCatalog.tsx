...
export const CFG: Partial<Record<MType, {
  ...
  1: { url: '/siege/monsters/reddemon.glb',          modelHeight: 1.886, height: 1.8,  speed: 3.2, gait: 'climb', sizeJitter: 0.10, speedJitter: 0.30, health: 100, attackRange: 1.8, attackMs: 1200, meleeContact: { dmg: [10, 50], kb: [1, 5], cooldownMs: 1200 }, attackSound: '/demon_attack.mp3', missSound: '/swoosh_miss_low.mp3', roarSound: '/demon_roar_1.mp3' },
  ...
  3: { url: '/siege/monsters/dfskeleton.glb',        modelHeight: 1.795, height: 6.0,  speed: 5.0, gait: 'climb', sizeJitter: 0.20, speedJitter: 0.10, health: 500, animSpeed: 3, attackRange: 4, attackMs: 2000, meleeContact: { dmg: [15, 45], kb: [2, 6], cooldownMs: 1800 } },
