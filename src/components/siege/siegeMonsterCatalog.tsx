...
import type { CaveCrawlConfig } from './caveCrawl';
...
export const CFG: Partial<Record<MType, {
  ...
  caveCrawl?: CaveCrawlConfig;   // opt-in: crouch+crawl into too-small hiding spaces, reach-in swipe
}>> = {
