...
// A build with VITE_BOOT_MAP set opens directly on that map (the Starblink deploy uses
// 'starblink'); every other build still starts in the SWW open world.
let active = BOOT_MAP ?? 'siege-test';
