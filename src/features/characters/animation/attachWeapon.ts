...
export function attachWeapon(
  ...
  /**
   * NO ANGLE CORRECTIONS HERE. I tried to fix the pistol's orientation by
   * reasoning about axes and made it worse twice — it ended up pointing
   * straight up. The rotation that belongs here is whatever the lineup editor
   * exports, per character per weapon, the same way the AK74's numbers were
   * produced. Guessing at Euler angles for a model I cannot see is not a
   * method, and this is where that guessing kept landing.
   */
