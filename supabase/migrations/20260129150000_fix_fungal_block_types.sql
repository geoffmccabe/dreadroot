-- Fix process_tree_growth to handle fungal block types correctly
-- Previously fungal_stem, fungal_cap_top, fungal_cap_underside all fell through to 't' (trunk)
-- This caused fungal trees to use ordinary tree textures
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      -- Encode block type (short codes for data efficiency)
