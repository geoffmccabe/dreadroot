-- Add glow_bark block type to process_tree_growth() encoder
-- Also add wide tree texture routing (wide trees use trunk/branch textures like original)
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      -- Encode block type (includes glow_bark for wide trees)
